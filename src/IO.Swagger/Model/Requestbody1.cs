...
namespace IO.Swagger.Model
{
    ...
    public partial class Requestbody1 :  IEquatable<Requestbody1>, IValidatableObject
    {
        ...
        public Requestbody1(int? perPage = default(int?), int? pageIndex = default(int?))
        {
        ...
        {
            return this.Equals(input as Requestbody1);
        }

        /// <summary>
        /// Returns true if Requestbody1 instances are equal
        /// </summary>
        /// <param name="input">Instance of Requestbody1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Requestbody1 input)
        {
            if (input == null)
                return false;
